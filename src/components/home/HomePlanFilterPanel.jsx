        ...
        <div className="mb-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              className={`flex-1 bg-white/5 border border-white/10 text-white rounded-lg px-2 py-1.5 text-xs ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-gray border-gray-400'}`}
            />
