        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-3">
              <h2 className="text-white font-black text-lg">{t.myGroups}</h2>
            ...
            <div className="px-4 pb-2 space-y-2 max-h-[60vh] overflow-y-auto">
              {myCommunities.length === 0 ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-gray-400 text-sm">{t.notJoinedAnyGroup}</p>
                  <motion.button
                    whileTap={{ scale: 0.95 }}
                ...
                myCommunities.map((c, i) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-12 h-12 rounded-xl overflow-hidden flex-shrink-0" style={{ border: `2px solid ${color}` }}>
                        {c.cover_image
                      ...
                      <div className="text-left flex-1 min-w-0">
                        ...
                        <p className="text-gray-400 text-xs">{c.city} · {c.member_count || 0} {t.membersCount}</p>
                      </div>
            ...
            {myCommunities.length > 0 && (
              <div className="px-4 pt-3">
                ...
                >
                  <Plus className="w-4 h-4" /> {t.findMoreGroups}
                </motion.button>
              </div>
            )}
          </motion.div>
