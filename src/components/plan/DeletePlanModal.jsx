      ...
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4">
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Deletar Plano?</h2>
            <p className="text-gray-400 text-sm">"{planTitle}"</p>
            <p className="text-gray-500 text-xs mt-3">
              Todo o plano será deletado permanentemente e o grupo será removido. Esta ação não pode ser desfeita.
            </p>
          </div>
