    ...
    <div className="space-y-5">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-gray-900 border border-gray-700 rounded-2xl pl-10 pr-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-[#00fea3] transition-colors"
        />
      </div>
