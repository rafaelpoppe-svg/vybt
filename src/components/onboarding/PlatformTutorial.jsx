...
const tutorialSlides = [
  ...
  },
  {
    ...
    description: 'Navega por festas próximas de ti. Filtra por tipo de música, localização e ambiente',
    emoji: '🗺️',
    gradient: 'from-blue-400 to-cyan-500'
  },
  {
    title: 'Junte-se e Interaja',
    description: 'Confirma a tua presença, envia mensagens no grupo e vota nos próximos eventos',
    emoji: '👥',
    gradient: 'from-purple-400 to-pink-500'
  },
  {
    title: 'Partilhe Histórias',
    description: 'Capture e partilhe momentos da festa com stories (máx. 5 por evento)',
    emoji: '📸',
    gradient: 'from-orange-400 to-red-500'
  },
  {
    title: 'Cria Teus Planos',
    description: 'Organiza a tua própria festa. Define local, hora, vibes e tema',
    emoji: '✨',
    gradient: 'from-yellow-400 to-orange-500'
  },
  {
    title: 'Faz Amigos',
    description: 'Conecta com pessoas com os mesmos gostos musicais e preferências de festa',
    emoji: '💬',
